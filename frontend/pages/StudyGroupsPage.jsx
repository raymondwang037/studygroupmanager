...
export default function StudyGroupsPage() {
  ...
  const isGroupMember = (organizers) => {
    ...
    console.log(organizers.some((organizer) => organizer._id === currentUser?._id))
      ...
      <ul>
        {studyGroups.map((group) => (
          <li key={group._id}>
            ...
            {group.room ? `${group.room.building} ${group.room.number}` : "Room not found"} on {new Date(group.date).toLocaleString('en-US', { dateStyle: 'medium', timeStyle: 'short' })} for {group.duration} minutes
